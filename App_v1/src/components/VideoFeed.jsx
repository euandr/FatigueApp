...
const VideoFeed = forwardRef(function VideoFeed(
  { isConnected, isStreaming, processedFrame, alertActive },
  ref
) {
      ...
      <div className="relative aspect-video bg-slate-800/50">
        ...
        {isStreaming && !isConnected && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-slate-900/60 backdrop-blur-sm">
            ...
            <p className="text-blue-400 font-mono">Conectando ao servidor...</p>
          </div>
        )}
      </div>
